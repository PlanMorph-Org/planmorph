...
export default function EngineerLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (role !== 'Engineer') {
        toast.error('This login is for engineers only. Please use the client login.');
        setIsLoading(false);
        return;
      }
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-xl">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            <Link href="/engineer/register" className="font-medium text-emerald-600 hover:text-emerald-500">
