...
export default function StudentLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (role !== 'Student') {
        toast.error('This login is for students only. Please use the appropriate login portal.');
        setIsLoading(false);
        return;
      }
  ...
  return (
    <div className="min-h-screen bg-brand flex relative overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] bg-indigo/[0.03] rounded-full blur-3xl" />
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-center items-center px-12 relative">
        ...
        >
          ...
          <h2 className="text-3xl font-display font-bold text-white leading-snug mb-4">
            Learn while <br />you <span className="text-indigo">earn.</span>
          </h2>
          <p className="text-white/35 leading-relaxed">
            Work on real client projects under licensed professional supervision. Gain hands-on experience, build your portfolio, and earn income while you learn.
          </p>
        </motion.div>
      </div>
        ...
        >
          <div className="glass-card rounded-2xl p-8 shadow-glass-lg">
            <div className="lg:hidden text-center mb-8">
              ...
              <span className="block mt-2 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-widest text-indigo bg-indigo/10 rounded-full border border-indigo/20 w-fit mx-auto">
                Student Portal
              </span>
            </div>

            <h1 className="text-2xl font-display font-bold text-white mb-1">Student Sign In</h1>
            <p className="text-sm text-white/35 mb-8">
              Don&apos;t have an account?{' '}
              <Link href="/student/register" className="text-indigo hover:text-indigo-light transition-colors">
            ...
            <div className="mt-5 bg-indigo/5 border border-indigo/15 rounded-lg p-3">
              <p className="text-xs text-indigo/80 flex items-start gap-2">
                ...
                Use the credentials sent to your email after your application is approved. If you haven&apos;t applied yet,{' '}
                <Link href="/student/register" className="text-indigo hover:text-indigo-light transition-colors underline">apply here</Link>.
              </p>
            </div>
