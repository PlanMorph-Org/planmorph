...
export default function ArchitectVerificationsPage() {
  ...
  const filteredVerifications = useMemo(() => {
    ...
    if (filter === 'Architectural') {
      return verifications.filter(v => v.verificationType === 'Architectural');
    }
    ...
    <ArchitectLayout>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Review architectural drawings and BOQ submissions.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            <p className="text-sm text-gray-500">Architectural</p>
            <p className="text-2xl font-semibold text-blue-700">{architecturalPending}</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                ...
                <div className="lg:col-span-2">
                  ...
                  {isFilesLoading ? (
                    <div className="text-center py-10">
                      <div className="animate-spin inline-block w-6 h-6 border-4 border-blue-200 border-t-blue-600 rounded-full" />
                    </div>
                  ) : files.length === 0 ? (
