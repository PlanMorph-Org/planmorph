        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedConstructionCost = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Designs_AspNetUsers_ArchitectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsWatermarked = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncludesConstruction = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConstructionContracts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConstructionContracts_AspNetUsers_ContractorId",
                        column: x => x.ContractorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ConstructionContracts_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ModificationRequests_Designs_DesignId",
                        column: x => x.DesignId,
                        principalTable: "Designs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ModificationRequests_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConstructionContracts_ContractorId",
                table: "ConstructionContracts",
                column: "ContractorId");

            migrationBuilder.CreateIndex(
                name: "IX_ConstructionContracts_OrderId",
                table: "ConstructionContracts",
                column: "OrderId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Designs_ArchitectId",
                table: "Designs",
                column: "ArchitectId");

            migrationBuilder.CreateIndex(
                name: "IX_ModificationRequests_DesignId",
                table: "ModificationRequests",
                column: "DesignId");

            migrationBuilder.CreateIndex(
                name: "IX_ModificationRequests_OrderId",
                table: "ModificationRequests",
                column: "OrderId");
